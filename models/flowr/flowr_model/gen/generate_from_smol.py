...
from flowr_model.data.datamodules import GeometricInterpolantDM
from flowr_model.data.datasets import GeometricDataset
from flowr_model.data.interpolate import (
    ComplexInterpolant,
    GeometricNoiseSampler,
)
from flowr_model.models.fm_pocket import LigandPocketCFM
from flowr_model.models.pocket import LigandGenerator, PocketEncoder
from flowr_model.scriptutil import generate_ligands_per_target
from flowr_model.util.pocket import PROLIF_INTERACTIONS, PocketComplexBatch
...
def load_model(args):
    ...
    if args.arch == "pocket":
        from flowr_model.models.fm_pocket import Integrator
    elif args.arch == "pocket_flex":
        from flowr_model.models.fm_pocket_flex import Integrator
...
def evaluate(args):
    ...
    # Limit number of systems if specified
    if args.max_systems is not None:
        systems = systems[:args.max_systems]
        print(f"Limiting to first {args.max_systems} systems for testing")
...
def get_args():
    ...
    parser.add_argument("--max_systems", type=int, default=None,
                        help="Maximum number of systems to process (for testing)")
