...
from flowr_root_model.data.datamodules import GeometricInterpolantDM
from flowr_root_model.data.dataset import GeometricDataset
from flowr_root_model.data.interpolate import (
    ComplexInterpolant,
...
from flowr_root_model.util.device import get_device, clear_cache
from flowr_root_model.util.pocket import PROLIF_INTERACTIONS, PocketComplexBatch
...
def load_model(args):
    ...
    if args.lora_finetuned:
        ...
        from flowr_root_model.models.pocket import SemlaCondAttention
