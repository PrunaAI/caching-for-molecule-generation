...
import flowr_root_model.util.metrics as Metrics
from flowr_root_model.constants import INPAINT_ENCODER as inpaint_mode_encoder
from flowr_root_model.data.data_info import GeneralInfos as DataInfos
from flowr_root_model.models.integrator import Integrator
from flowr_root_model.models.losses import LossComputer
from flowr_root_model.models.mol_builder import MolBuilder
from flowr_root_model.models.score_modifier import MaxGaussianModifier, MinGaussianModifier
from flowr_root_model.models.semla import MolecularGenerator
from flowr_root_model.util.tokeniser import Vocabulary
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.self_condition_mode == "residual":
            from flowr_root_model.models.self_conditioning import SelfConditioningResidualLayer
        ...
        if self.train_confidence:
            ...
            from flowr_root_model.models.pocket import ConfidenceModule
